    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Internal service-to-service endpoints (called by booking-service)
                        // These are public because JWT propagation in Feign may not work reliably
                        .requestMatchers("/payments/initiate").permitAll()
                        .requestMatchers("/payments/booking/**").permitAll()
