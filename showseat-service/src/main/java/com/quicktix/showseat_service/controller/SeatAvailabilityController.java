...
public class SeatAvailabilityController {
    ...
    @Operation(
        summary = "Get seat availability for show",
        description = "Retrieve seat availability and status for a given show"
    )
    public ResponseEntity<ApiResponse<SeatAvailabilityResponse>> getSeatAvailability(
        ...
        SeatAvailabilityResponse response =
                seatAvailabilityService.getSeatAvailability(showId);
    ...
    @Operation(
        ...
        description = "Check whether a specific seat is available for a show"
    )
    public ResponseEntity<ApiResponse<Boolean>> isSeatAvailable(
        ...
        boolean available =
                seatAvailabilityService.isSeatAvailable(showId, seatNo);
